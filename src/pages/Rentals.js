...
const Rentals = () => {
    ...
    const getRentalsList = async () => {
        ...
        const rentals = await SwiftStayContract.getRentals();
    ...
    const bookProperty = async (_id, _price) => {
        if (data.network === networksMap[networkDeployedTo]) {
            try {
                ...
                const totalBookingPriceETH = await SwiftStayContract.convertFromUSD(
                    utils.parseEther(totalBookingPriceUSD.toString(), "ether")
                );
                const book_tx = await SwiftStayContract.bookDates(
                    _id,
                    _datefrom,
                    _dateto,
                            ...
                            return (
                                <>
                                    <div className="rental-div" key={i}>
                                        <img className="rental-img" src={e.imgUrl} alt={"logo"}></img>
