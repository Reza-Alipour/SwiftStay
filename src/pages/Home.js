                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="banner-title text-center">
                                <h1 style={{color: 'darkslategrey'}}>Find the best location for your trip</h1>
                                <p className="opacity-full" style={{color: "darkslategrey"}}>
                                    Swift Stay MVP for our university course project
                                </p>
                            </div>
                        </div>
